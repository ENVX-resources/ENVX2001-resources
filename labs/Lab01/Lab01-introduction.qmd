...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/9/98/Aspens_at_Sunset%2C_Purgatory.jpg')
```
...
[^1]: Ripple, W. J., Beschta, R. L., Wolf, C., Painter, L. E., & Wirsing, A. J. (2025). The Strength of the Yellowstone Trophic Cascade after Wolf Reintroduction. Global Ecology and Conservation, 58. https://doi.org/10.1016/j.gecco.2025.e03428
...
[^2]: MacNulty, D. R., Cooper, D., Procko, M., & Clark-Wolf, T. J. (2025). Flawed analysis invalidates claim of a strong Yellowstone trophic cascade after wolf reintroduction: A comment on Ripple et al. (2025). Global Ecology and Conservation, 63. https://doi.org/10.1016/j.gecco.2025.e03899N.

```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/c/cb/Wolves_of_Yellowstone_%2821575454571%29.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/c/c4/Linckia_laevigata_108616340.jpg')
```
...
[^3]: Thomson, G., & Thompson, C. (1982). Movement and size stucture in a poulation of the blue starfish Linckia laevigata (L.) at Lizard Island, Great Barrier Reef. Marine and Freshwater Research, 33(3), 561. https://doi.org/10.1071/mf9820561
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/f/fe/Black_Noddy_Lady_Elliot.JPG')
```
...
*The following exercise involves real data from Lovett et al. (2000)*[^4]

[^4]: *Lovett GM, Weathers KC & Sobczak WV (2000) Ecological Applications 10: 73-84.*

```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/d/db/Diamond_Notch_Falls%2C_Spruceton%2C_NY%2C_2021.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/8/85/Evergreen_Mountain_in_autumn_from_Buck_Ridge_Lookout%2C_Catskills.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/5/50/Lymnaea_stagnalis_-_Spitzschlammschnecke.jpg')
```
...
[^5]: Juha Karjalainen, Hu, X., Mikko Mäkinen, Karjalainen, A. K., Järvistö, J., Kaisa Järvenpää, Sepponen, M., & Leppänen, M. T. (2023). Sulfate sensitivity of aquatic organism in soft freshwaters explored by toxicity tests and species sensitivity distribution. Ecotoxicology and Environmental Safety, 258, 114984–114984. https://doi.org/10.1016/j.ecoenv.2023.114984
...
*The following case study involves real data from Hobbs et al. (2024)[^6], which was used by Ripple et al. (2025) in their analysis*

[^6]: *Thompson Hobbs, Johnston, D. B., Marshall, K. N., Wolf, E. C., & Cooper, D. J. (2024). Does restoring apex predators to food webs restore ecosystems? Large carnivores in Yellowstone as a model system. Ecological Monographs, 94(2). https://doi.org/10.1002/ecm.1598*

```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/f/f6/Heart_Spring_and_Lion_Geyser_in_Yellowstone_NP.jpg')
```
