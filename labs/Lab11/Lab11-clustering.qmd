...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/d/d4/Brushes-and-paint.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/f/f2/Old_books.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/d/d4/Euclid%27s_Elements%2C_1482.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/e/ed/Food_basket.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/1/12/Estonian_Museum_of_Natural_History_Specimen_No_180314_photo_%28g1_g1-5028_1_jpg%29.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/6/6e/Trilobiti_.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/9/93/Water_colour_painting_by_Mong_kyaw_sing_marma.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Iglesia_de_Nuestra_Señora_de_La_Blanca%2C_Cardejón%2C_España%2C_2012-09-01%2C_DD_02.JPG/1920px-Iglesia_de_Nuestra_Señora_de_La_Blanca%2C_Cardejón%2C_España%2C_2012-09-01%2C_DD_02.JPG')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/8/82/Clarkia_pulchella_-_Jardin_des_Plantes.jpg')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/f/fa/The_Ancestors_Tale_Mammals_Phylogenetic_Tree_in_mya.png')
```
...
```{r, echo = FALSE}
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/5/56/CSIRO_ScienceImage_75_Mountain_Ash_Eucalyptus_regnans_Magdena_Tasmania.jpg')
```
