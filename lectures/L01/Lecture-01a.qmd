...
## Can crop rotation restore soil health?

A greenhouse experiment tested how soil conditioned by different crops affects the growth of subsequent plantings.
...
#| warning: false
#| message: false
crops <- read.csv("data/crop_rotation_clean.csv")

ggplot(crops, aes(x = training_crop, y = total_mass_g, fill = training_crop)) +
  geom_boxplot(show.legend = FALSE) +
  labs(x = "Previous crop", y = "Total plant mass (g)") +
  theme_minimal(base_size = 18)
```
