...
## Hawks of Iowa: three species, four measurements

Researchers at Lake MacBride, Iowa trapped three hawk species over a decade and measured wing length, weight, culmen, and hallux on each bird. With four variables per bird, we can use PCA to collapse the data into two dimensions.
...
Four measurements, reduced to two axes, and the species separate cleanly. You will learn to do this with **multivariate methods** (Weeks 10--12).
