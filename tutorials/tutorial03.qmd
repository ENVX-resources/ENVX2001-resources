...
::: {.callout-note}
Note that `sleep` is actually a paired design — each patient was measured under both drugs. We are treating the two groups as independent here to illustrate the diagnostic workflow; the pairing structure is ignored for this exercise.
:::
